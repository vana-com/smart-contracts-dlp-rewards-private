...
describe("DLP System Tests", () => {
  ...
  describe("Configuration", () => {
    ...
    it("should updateDlpRegistrationDepositAmount when maintainer", async function () {
      ...
      (await dlpRegistry.dlpRegistrationDepositAmount()).should.eq(newDepositAmount);
    });
  ...
  describe("DLP Registration", () => {
    ...
    it("should registerDlp successfully", async function () {
      ...
      (await dlpRegistry.dlpsByAddress(dlp1Info.dlpAddress)).should.deep.eq(dlp1);
  ...
  describe("Epoch Creation", () => {
    ...
    it.only("should createEpochsUntilBlockNumber properly", async function () {
      ...
      await vanaEpoch.connect(user1).createEpochsUntilBlockNumber(specificBlock);
